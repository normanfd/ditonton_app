...
// in ditonton/test/presentation/pages/tvshow/season_detail_tvshow_page_test.dart.
...
import 'package:ditonton/domain/entities/season_detail.dart' as _i5;
import 'package:ditonton/domain/usecases/tvshow/get_season_detail.dart' as _i2;
...
class MockSeasonDetailNotifier extends _i1.Mock
  ...
  @override
  _i2.GetSeasonDetail get getSeasonEpisode => (super.noSuchMethod(
        Invocation.getter(#getSeasonEpisode),
  ...
  @override
  List<_i5.SeasonEpisode> get seasonDetail => (super.noSuchMethod(
        Invocation.getter(#seasonDetail),
        returnValue: <_i5.SeasonEpisode>[],
      ) as List<_i5.SeasonEpisode>);
  ...
  @override
  _i7.Future<void> fetchSeasonDetailTvshow(
    int? seriesId,
    int? seasonId,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchSeasonDetailTvshow,
          [
            seriesId,
            seasonId,
          ],
